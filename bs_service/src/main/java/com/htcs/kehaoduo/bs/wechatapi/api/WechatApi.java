package com.htcs.kehaoduo.bs.wechatapi.api;
...
public class WechatApi implements Serializable {
    ...
    private transient OkHttpClient client = new OkHttpClient.Builder()
    ...
    public String genqrcodeurl() {
        return conf.get("API_qrcode_img") + session.getUuid();
    }
    ...
    public boolean webwxinit() {
        ...
        this.user = gson.fromJson(response.get("User"), new TypeToken<Map<String, Object>>() {
        }.getType());
     ...
     * @return
     */
    public JsonObject wxSendTextMessage(String msg, String to) {
    ...
    public void sendText(String msg, String uid) {
        this.wxSendTextMessage(msg, uid);
    }
    ...
    public JsonArray getPublicUsersList() {
        return publicUsersList;
    }

    public JsonArray getSpecialUsersList() {
